  ...
  return (
    <Tooltip.Provider delay={450} closeDelay={80}>
      <div className="isolate min-h-svh overflow-x-hidden bg-paper text-ink">
        ...
        <main
          className={`mx-auto min-h-svh w-full max-w-3xl px-4 pt-6 sm:px-6 sm:pt-10 ${isPracticeRoute ? "pb-[max(1rem,env(safe-area-inset-bottom))]" : "pb-[calc(7rem+env(safe-area-inset-bottom))]"}`}
        >
          <Outlet />
        </main>
      </div>
